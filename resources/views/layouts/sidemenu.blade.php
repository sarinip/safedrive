    ...
    <ul class="nav">
        ...
        @if (session()->get('user')[0]->role == 'STUDENT')
            ...
            @if (session()->get('user')[0]->status == 'PAID')
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/dashboard') }}" ari a-expanded="false" aria-controls="students">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/student/appointment') }}" aria-expanded="false"
                        ...
                        <span class="menu-title">Practical Class</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/theory-class/student-view') }}" aria-expanded="false"
                        aria-controls="students">
                        <i class="icon-contract menu-icon"></i>
                        <span class="menu-title">Theory Class</span>
                    </a>
                </li>
                <li class="nav-item">
        ...
        @if (session()->get('user')[0]->role == 'ADMIN')
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/core-dashboard') }}" aria-expanded="false">
                    <i class="icon-grid menu-icon"></i>
                    <span class="menu-title">Dashboard</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/instructor/new') }}" aria-expanded="false">
                    <i class="icon-head menu-icon"></i>
                    <span class="menu-title">Add Instructors</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/vehicle/new') }}" aria-expanded="falae" aria-controls="instructor">
                    <i class="icon-contract menu-icon"></i>
                    <span class="menu-title">Add Vehicle Info</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/package/new') }}" aria-expanded="false">
                    <i class="icon-contract menu-icon"></i>
                    <span class="menu-title">Add Packages</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/exam/new') }}" aria-expanded="false">
                    <i class="icon-contract menu-icon"></i>
                    <span class="menu-title">Add Exams</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/theory-class/list') }}" aria-expanded="false"
                    aria-controls="students">
                    <i class="icon-paper menu-icon"></i>
                    <span class="menu-title">Add Theory Class</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/report/student') }}" aria-expanded="false">
                    <i class="icon-paper menu-icon"></i>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/report/exam') }}" aria-expanded="false"
                    aria-controls="students">
                    <i class="icon-paper menu-icon"></i>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/report/theory_class') }}" aria-expanded="false"
                    aria-controls="students">
                    <i class="icon-paper menu-icon"></i>
                    <span class="menu-title">Theory Class Report</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/report/practical_class') }}" aria-expanded="false"
                    aria-controls="students">
                    <i class="icon-paper menu-icon"></i>
                    <span class="menu-title">Practical Class Report</span>
                </a>
            </li>
            <li class="nav-item">
